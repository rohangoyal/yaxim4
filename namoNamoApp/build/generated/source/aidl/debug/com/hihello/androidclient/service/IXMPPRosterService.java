 ...
 * Original file: D:\\New folder (2)\\yaxim4\\namoNamoApp\\src\\main\\aidl\\com\\hihello\\androidclient\\service\\IXMPPRosterService.aidl
 */
package com.hihello.androidclient.service;
public interface IXMPPRosterService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.hihello.androidclient.service.IXMPPRosterService
{
private static final java.lang.String DESCRIPTOR = "com.hihello.androidclient.service.IXMPPRosterService";
...
/**
 * Cast an IBinder object into an com.hihello.androidclient.service.IXMPPRosterService interface,
 * generating a proxy if needed.
 */
public static com.hihello.androidclient.service.IXMPPRosterService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.hihello.androidclient.service.IXMPPRosterService))) {
return ((com.hihello.androidclient.service.IXMPPRosterService)iin);
}
return new com.hihello.androidclient.service.IXMPPRosterService.Stub.Proxy(obj);
}
...
java.lang.String _arg0;
_arg0 = data.readString();
java.lang.String _result = this.changePassword(_arg0);
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
{
data.enforceInterface(DESCRIPTOR);
com.hihello.androidclient.IXMPPRosterCallback _arg0;
_arg0 = com.hihello.androidclient.IXMPPRosterCallback.Stub.asInterface(data.readStrongBinder());
...
case TRANSACTION_hasRosterItem:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
boolean _result = this.hasRosterItem(_arg0);
reply.writeNoException();
...
private static class Proxy implements com.hihello.androidclient.service.IXMPPRosterService
{
...
@Override public java.lang.String changePassword(java.lang.String newPassword) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
/* callback methods */
@Override public void registerRosterCallback(com.hihello.androidclient.IXMPPRosterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void unregisterRosterCallback(com.hihello.androidclient.IXMPPRosterCallback callback) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public boolean hasRosterItem(java.lang.String jid) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
mRemote.transact(Stub.TRANSACTION_hasRosterItem, _data, _reply, 0);
_reply.readException();
...
static final int TRANSACTION_changePassword = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_registerRosterCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_unregisterRosterCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_hasRosterItem = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
}
/* hack: use int because enums are not trivially parcellable */
...
public java.lang.String changePassword(java.lang.String newPassword) throws android.os.RemoteException;
/* callback methods */
public void registerRosterCallback(com.hihello.androidclient.IXMPPRosterCallback callback) throws android.os.RemoteException;
public void unregisterRosterCallback(com.hihello.androidclient.IXMPPRosterCallback callback) throws android.os.RemoteException;
public boolean hasRosterItem(java.lang.String jid) throws android.os.RemoteException;
}
