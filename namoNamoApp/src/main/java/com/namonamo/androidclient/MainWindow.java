...
import com.namonamo.androidclient.IXMPPRosterCallback.Stub;
...
import com.namonamo.androidclient.dialogs.AddRosterItemDialog;
import com.namonamo.androidclient.dialogs.ChangeStatusDialog;
import com.namonamo.androidclient.dialogs.FirstStartDialog;
import com.namonamo.androidclient.dialogs.GroupNameView;
import com.namonamo.androidclient.preferences.AccountPrefs;
...
import com.namonamo.androidclient.util.SimpleCursorTreeAdapter;
...
public class MainWindow extends ExpandableListActivity {
	...
	protected void onPause() {
		...
		UIApplication.getApp(this).mMTM.unbindDisplayActivity(this);
		unbindXMPPService();
		storeExpandedState();
	}
	...
	protected void onResume() {
		...
		UIApplication.getApp(this).mMTM.bindDisplayActivity(this);
	...
	private void startChatActivity(String user, String userName, String message) {
		...
		chatIntent
				.putExtra(
						com.namonamo.androidclient.chat.ChatWindow.INTENT_EXTRA_USERNAME,
						userName);
		if (message != null) {
			chatIntent
					.putExtra(
							com.namonamo.androidclient.chat.ChatWindow.INTENT_EXTRA_MESSAGE,
							message);
		}
	...
	private boolean applyMainMenuChoice(MenuItem item) {
		...
		case R.id.menu_settings:
			startActivity(new Intent(this, SettingPrefs.class));
			return true;
	...
	private void updateConnectionState(ConnectionState cs) {
		...
		case OFFLINE:
			...
			setProgressBarIndeterminateVisibility(spinTheSpinner);
			break;
		case ONLINE:
