...
public class RosterProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.namonamo.androidclient.provider.Roster";
	...
	private MyRunnable mNotifyChange = new MyRunnable();
	...
	private void notifyChange(Uri noteUri) {
		mNotifyChange.uri = noteUri;
