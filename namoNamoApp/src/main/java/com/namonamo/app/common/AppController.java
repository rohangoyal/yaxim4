...
import com.namonamo.app.activity.EarnPoint;
import com.namonamo.app.activity.MyProfile;
import com.namonamo.app.activity.MyWallet;
import com.namonamo.app.activity.Ranking;
import com.namonamo.app.activity.SettingPrefs;

public class AppController {

	public static final int ACTION_NAMONAMO_CONTACT = 1;
	...
	public static Intent getIntentForMenu(Context ctx, int position) {
		...
		case ACTION_INVITE:
			...
			String text = "Hey, I am using NamoNamo App! Download Link: https://play.google.com/store/apps/details?id=com.namonamo.app";
		...
		case ACTION_LIKE_US:
			...
			break;
		case ACTION_ABOUT:
			String aboutUrl = "http://www.namonamoapp.com";
