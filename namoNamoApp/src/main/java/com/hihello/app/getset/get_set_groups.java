...
public class get_set_groups
{
    ...
    String admin_pich;
    String group_pich;
    String group_pic,title,comment,follow,profile_name;

    public get_set_groups(int id, String admin_name, String group_name, String about, String alt_mob, String cate, String subcate, String email, String web_url, String state, String city, String address, String date,String admin_pic, String group_pic, String title, String comment, String follow, String profile_name,String admin_pich,String group_pich) {
        this.id = id;
