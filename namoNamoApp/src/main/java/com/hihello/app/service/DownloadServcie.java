...
import com.hihello.app.common.HiHelloDownloadManager;
	...
	protected void onHandleIntent(Intent intent) {
		...
		try {
			...
			if (fileType.equalsIgnoreCase("IMAGE"))
				localPath = HiHelloDownloadManager.downloadImageFile(
						getApplicationContext(), fileUrl);
			else if (fileType.equalsIgnoreCase("VIDEO"))
				localPath = HiHelloDownloadManager.downloadVideoFile(
						getApplicationContext(), fileUrl);
			else if(fileType.equalsIgnoreCase("AUDIO"))
				localPath = HiHelloDownloadManager.downloadAudioFile(
						getApplicationContext(), fileUrl);
