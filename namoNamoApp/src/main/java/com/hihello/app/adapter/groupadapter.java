...
import com.hihello.app.activity.Group_view_main;
...
public class groupadapter extends BaseAdapter {
    ...
    public groupadapter(ArrayList<get_allgroup> data, int width) {
        this.data=data;
        this.width=width;
...
//    public groupadapter(ArrayList<get_allgroup> data,ArrayList<ArrayList<String>> listoflist,int width) {
//        this.data=data;
...
//    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        v=inflater.inflate(R.layout.groupadapter, parent, false);
...
//        holder.submitcomment=(TextView)v.findViewById(R.id.commentsubmit);
        ...
        holder.follower.setText(data.get(position).getFollow());
...
//        blink(holder.showcomment, clist);
       ...
       holder.count.setText(data.get(position).getComment());

        ImageLoader imageLoader = ImageLoader.getInstance();
        imageLoader.init(ImageLoaderConfiguration.createDefault(context));
        imageLoader.getInstance().displayImage(HiHelloConstant.url + "img/" + data.get(position).getGroup_pic(), holder.admin_pic, options, animateFirstListener);

        imageLoader.getInstance().displayImage(HiHelloConstant.url+"img/"+data.get(position).getAdmin_pic(), holder.group_pic, options, animateFirstListener);

//        Picasso.with(context)
//                .load(HiHelloConstant.url+"img/"+data.get(position).getGroup_pic())
//                .error(R.drawable.backheaderimage)
//                .placeholder(R.drawable.backheaderimage)
//                .into(holder.admin_pic);
//        Picasso.with(context)
//                .load(HiHelloConstant.url+"img/"+data.get(position).getAdmin_pic())
//                .error(R.drawable.backheaderimage)
//                .placeholder(R.drawable.backheaderimage)
...
//        });
        ...
        holder.admin_pic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent in = new Intent(context, Group_view_main.class);
                ...
                in.putExtra("group_pich",data.get(position).getAdmin_pich());
        ...
        holder.group_pic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.putExtra("pic",data.get(position).getAdmin_pic());
                in.putExtra("pich",data.get(position).getAdmin_pich());
                context.startActivity(in);
            }
        });
