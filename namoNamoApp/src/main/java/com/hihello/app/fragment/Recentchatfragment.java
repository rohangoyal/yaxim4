...
import com.hihello.app.activity.DailyMessageActivity;
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
            ...
            if (arg2 == 0) {
                ...
                if (contact.getDisplayName() == null) {
                    ...
                    HiHelloNewConstant.picurl=contact.getProfilePic();
                    HiHelloNewConstant.status=contact.getStatus();
                    HiHelloNewConstant.mobnumber=contact.getMobileNo();
                    Log.e("status", HiHelloNewConstant.status);
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        HiHelloSharedPrefrence.setChatPageInit(getActivity(), true);
    ...
    private AdapterView.OnItemLongClickListener chatItemLongClick = new AdapterView.OnItemLongClickListener() {
        ...
        public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
            ...
            if (contact.getDisplayName() == null) {
                ...
                HiHelloNewConstant.status=contact.getStatus();
                HiHelloNewConstant.mobnumber=contact.getMobileNo();
//                Log.e("statusssssss", HiHelloNewConstant.picurl+"");
                contact.setDisplayName(contact.getMobileNo());
            }
            HiHelloNewConstant.username=contact.getDisplayName();
            HiHelloNewConstant.picurl=contact.getProfilePic();
            ...
            if(HiHelloNewConstant.picurl!=null) {
                Log.e("status", HiHelloNewConstant.picurl);
            }
//			startChatActivity(contact.getUserJID(),
//					contact.getDisplayName(), null);
            if (arg2 > 0) {
