...
import com.hihello.app.apicall.GetTopTenContactRewardApiCall;
	...
	private void startFetchingAllData() {
		new AsyncTask<Void, Void, Void>() {
			...
			protected Void doInBackground(Void... params) {
				if (getActivity() != null) {
					ArrayList<String> items = hiHelloContactDBService
			...
			protected void onPostExecute(Void result) {
				GetTopTenContactRewardApiCall apiCall = new GetTopTenContactRewardApiCall(
						...
						HiHelloSharedPrefrence.getUserId(getActivity()));
