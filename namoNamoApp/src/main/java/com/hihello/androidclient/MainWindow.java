...
import com.hihello.androidclient.IXMPPRosterCallback.Stub;
...
import com.hihello.androidclient.dialogs.AddRosterItemDialog;
import com.hihello.androidclient.dialogs.ChangeStatusDialog;
import com.hihello.androidclient.dialogs.FirstStartDialog;
import com.hihello.androidclient.dialogs.GroupNameView;
//import com.hihello.androidclient.preferences.AccountPrefs;
...
import com.hihello.androidclient.util.SimpleCursorTreeAdapter;
...
public class MainWindow extends ExpandableListActivity {
	...
	private void startChatActivity(String user, String userName, String message) {
		Intent chatIntent = new Intent(this,
				com.hihello.androidclient.chat.ChatWindow.class);
		Uri userNameUri = Uri.parse(user);
		chatIntent.setData(userNameUri);
		chatIntent
				.putExtra(
						com.hihello.androidclient.chat.ChatWindow.INTENT_EXTRA_USERNAME,
						userName);
		if (message != null) {
			chatIntent
					.putExtra(
							com.hihello.androidclient.chat.ChatWindow.INTENT_EXTRA_MESSAGE,
							message);
		}
